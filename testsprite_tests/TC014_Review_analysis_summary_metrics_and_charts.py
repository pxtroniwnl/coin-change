...
async def run_test():
    ...
    try:
        ...
        # -> Click the 'Análisis' link (element index 16) to navigate to the analysis page.
        # link "Análisis"
        elem = page.locator("xpath=/html/body/nav/div/nav/a[2]").nth(0)
        await elem.wait_for(state="visible", timeout=10000)
        await elem.click()
        
        # -> Set the maximum amount to 80 in element 277 and submit the analysis by clicking element 371.
